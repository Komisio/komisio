...
select publish_reception_review(current_setting('test.tenant')::uuid,current_setting('test.review')::uuid,current_setting('test.session')::uuid,1,null,current_setting('test.terms')::uuid,'{"metadata":{"description":{"value":"TEST shirt","sourceIds":["d0000000-0000-4000-8000-000000000010"],"certainty":"observed"}},"price":{"currency":"SEK","amount":"80.00","rationale":"TEST","sourceIds":["d0000000-0000-4000-8000-000000000010"]},"questions":[]}'::jsonb,now()+interval '1 day');
