-- Restore the final published validator after out-of-order local migration application.
-- Equivalent to the notification validator on a fresh, ordered database.
