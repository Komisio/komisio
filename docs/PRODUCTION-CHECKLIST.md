...
| P3b | GitHub: the `production-print` environment with `PRINT_SUPABASE_URL` and `PRINT_PUBLISHABLE_KEY` of the production project, and a `print-v*` tag after P1 so the production Komisio Print package exists                                                                                                                                                                                                                                      | The download under Settings, Printing works on production                        |
