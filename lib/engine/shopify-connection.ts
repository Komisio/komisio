...
export const shopifyErrorCodes = [
  ...
  'SHOPIFY_SETTINGS_UNAVAILABLE',
  'SHOPIFY_SETTINGS_CHANGED',
  'SHOPIFY_SETTINGS_LOCKED',
  'SHOPIFY_PUBLICATION_INVALID',
  'SHOPIFY_PUBLICATION_FAILED',
  'SHOPIFY_NO_LOCATION',
  ...
  'ITEM_ALREADY_SOLD',
  'PLAN_PLUS_REQUIRED',
  'SHOPIFY_UPLOAD_REJECTED',
  'SHOPIFY_UPLOAD_FAILED',
  'SHOPIFY_IMAGE_REJECTED',
  'SHOPIFY_IMAGE_INVALID',
  'SHOPIFY_IMAGE_PRODUCT_REQUIRED',
  'SHOPIFY_IMAGE_PRODUCT_CHANGED',
  'SHOPIFY_SALE_MISSING',
  'SHOPIFY_REFUND_LINE_UNKNOWN',
