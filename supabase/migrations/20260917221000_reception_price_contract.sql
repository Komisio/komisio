-- Accept the strict price contract; keep prior deployed prompts during rollout.
...
begin
 ...
 if p_request is null or p_session is null or p_revision is null or p_revision<1
  ...
  or (p_prompt is null or p_prompt not in ('reception-v1','reception-v2','reception-v3','reception-v4','reception-batch-v1','reception-batch-v2','reception-batch-v3','reception-batch-v4')) then raise exception 'INVALID_INPUT'; end if;
